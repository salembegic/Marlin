 ...
 */
#define Z_STEPPER_AUTO_ALIGN  //SB
  ...
  #define Z_STEPPER_ALIGN_ACC        0.01 // Stop iterating early if the accuracy is better than this  //SB
...
#define SET_PROGRESS_MANUALLY
  ...
  #define M73_REPORT                    // Report M73 values to host  //SB
...
// LCD Print Progress options. Multiple times may be displayed in turn.
   ...
   * point in the file.
   */
  #define POWER_LOSS_RECOVERY  //SB
  #if ENABLED(POWER_LOSS_RECOVERY)
    #define PLR_ENABLED_DEFAULT       true // Power-Loss Recovery enabled by default. (Set with 'M413 Sn' & M500)  //SB
    ...
    #define POWER_LOSS_STATE           HIGH // State of pin indicating power-loss  //SB
    #define POWER_LOSS_PULLUP             // Set pullup / pulldown as appropriate for your sensor  //SB
    //#define POWER_LOSS_PULLDOWN

    #define POWER_LOSS_ZRAISE        2    // (mm) Z axis raise on resume (on power-loss with UPS)  //SB
    #define POWER_LOSS_PURGE_LEN    20    // (mm) Length of filament to purge on resume  //SB

    // Without a POWER_LOSS_PIN the following option helps reduce wear on the SD card,
    // especially with "vase mode" printing. Set too high and vases cannot be continued.
    #define POWER_LOSS_MIN_Z_CHANGE    0.05 // (mm) Minimum Z change before saving power-loss data

    #define BACKUP_POWER_SUPPLY           // Backup power / UPS to move the steppers on power-loss  //SB
    #if ENABLED(BACKUP_POWER_SUPPLY)
      #define POWER_LOSS_RETRACT_LEN   10 // (mm) Length of filament to retract on fail  //SB
    #endif
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_ZPROBE_OFFSET          // Combine M851 Z and Babystepping  //SB
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT       1000        // (mA) RMS current. Multiply by 1.414 for peak current.  //SB
   ...
   */
  #define MONITOR_DRIVER_STATUS  //SB
  ...
  #define X_HYBRID_THRESHOLD     120  // [mm/s]  //SB
  #define X2_HYBRID_THRESHOLD    120  // [mm/s]  //SB
  #define Y_HYBRID_THRESHOLD     120  // [mm/s]  //SB
  #define Y2_HYBRID_THRESHOLD    120  // [mm/s]  //SB
 ...
 */
#define AUTO_REPORT_POSITION  //SB
...
#define HOST_ACTION_COMMANDS
  ...
  #define HOST_PROMPT_SUPPORT             // Initiate host prompts to get user feedback
    ...
    #define HOST_STATUS_NOTIFICATIONS   // Send some status messages to the host as notifications  //SB
  #endif
...
// M42 - Set pin states
//
#define DIRECT_PIN_CONTROL  //SB

//
// M43 - display pin status, toggle pins, watch pins, watch endstops & toggle LED, test servo probe
//
#define PINS_DEBUGGING  //SB
